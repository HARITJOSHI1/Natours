...
var renderAlert = function renderAlert(type, msg) {
  var el = "<div class = \"alert alert--".concat(type, "\"> ").concat(msg, " </div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.renderAlert)('error', 'There was an error is log out. Please try again later');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateUserInfo.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePassword = exports.updateUserInfo = void 0;
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(pass, repass, currPass) {
    var _yield$axios$patch2, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.renderAlert)('error', _context.t0);
...
var _updateUserInfo = require("./updateUserInfo");
...
var form2 = document.querySelector('.form-user-data');
var form3 = document.querySelector('.form-user-settings');
var logOutBtn = document.querySelector('.nav__el--logout');
var bookTourBtn = document.getElementById('book-tour'); // const locations = document.getElementById('map').dataset.locations;
// if(locations){
...
if (form1) {
  form1.addEventListener('submit', function (event) {
    ...
    (0, _login.login)(email.value, pwd.value);
  });
} else if (form2) {
